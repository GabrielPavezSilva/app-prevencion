...
class PersonalService:
    ...
    def obtener_personal(self, search: str = None) -> List[PersonalResponse]:
        logger.info(f"Obteniendo personal (search={search})")
        return self.repository.get_personal(search)
