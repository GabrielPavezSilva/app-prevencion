...
from app.api.v1.endpoints import personal, auth, stats, asignaciones, templates, reportes, inventario, devoluciones, superadmin
...
api_router.include_router(devoluciones.router, prefix="/returns", tags=["Devoluciones"])
